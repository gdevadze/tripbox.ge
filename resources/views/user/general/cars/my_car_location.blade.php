...
<script>
        ...
        function initMap() {
            ...
            var myLatLng = {lat: {{ $carCoordinates['carStatus']['lat'] }}, lng: {{ $carCoordinates['carStatus']['lon'] }}}; // Example coordinates (New York City)
            ...
            var marker = new google.maps.Marker({
                map: map,
                position: myLatLng,
                title: 'Your Car location' // Optional title for the marker
            });
        }
