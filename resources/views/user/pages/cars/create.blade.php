...
<a href="/contact" target="_blank" style="    margin-bottom: 20px;background: linear-gradient(90deg, rgba(86, 173, 56, 0.4) 0%, rgba(0, 132, 97, 0.4) 100%); width: 100%; padding-top: 10px; padding-bottom: 10px; border-radius: 10px; display: block; text-align: center; color: #31344B;">
...
<!--</svg>-->
                        ...
                        <input class="form-control" name="address" id="address"  placeholder="@lang('enter_adressss')">
                    </div>
...
{{--                    </div>--}}
                    ...
                    <div class="col-md-3  mt-2">
                        ...
                        <select id="fuel_type" class="form-control" name="fuel_type" required>
                            ...
                            @foreach($fuelTypes as $fuelType)
                                <option value="{{ $fuelType['key'] }}">{{ $fuelType['key'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3  mt-2">
                    ...
                    <div class="col-md-3  mt-2">
                        ...
                        <input class="form-control" name="number_of_seats" required placeholder="@lang('enterss')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    <div class="col-md-3  mt-2">
                        <p style="color:#000000;margin-bottom:10px;font-weight: bold;">@lang('car_number')</p>
                        <input class="form-control" name="vehicle_number" required placeholder="@lang('enterss')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    <div class="col-md-3  mt-2">
                        <p style="color:#000000;margin-bottom:10px;font-weight: bold;">@lang('prices_1')</p>
                        <input class="form-control field-amount" name="price_1" placeholder="@lang('prices_1')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    <div class="col-md-3  mt-2">
                        <p style="color:#000000;margin-bottom:10px;font-weight: bold;">@lang('prices_2_4')</p>
                        <input class="form-control field-amount" name="price" required placeholder="@lang('prices_2_4')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    <div class="col-md-3  mt-2">
                        <p style="color:#000000;margin-bottom:10px;font-weight: bold;">@lang('prices_5_9')</p>
                        <input class="form-control field-amount" name="price_5_9" required placeholder="@lang('prices_5_9')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    <div class="col-md-3  mt-2">
                        <p style="color:#000000;margin-bottom:10px;font-weight: bold;">@lang('price_10_plus')</p>
                        <input class="form-control field-amount" name="price_10" required placeholder="@lang('price_10_plus')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    <div class="col-md-3  mt-2">
                        <p style="color:#000000;margin-bottom:10px;font-weight: bold;">@lang('deposit')</p>
                        <input class="form-control" name="deposit" placeholder="@lang('deposit')" style="border: 1px solid #48713A!important;border-radius: 20px;">
                    </div>
                    {{-----
                <h5 class="mt-4">ფოტოები</h5>
                    ...
                    <section class="card card-body border-0 shadow-sm p-4 mb-4" id="photos" style="margin-top: 20px;">
                    <h2 class="h4 mb-4"><i class="fi-image text-primary fs-5 mt-n1 me-2"></i>@lang('car_photos')</h2>
                  <div class="alert alert-info mb-4" role="alert">
                        <div class="d-flex"><i class="fi-alert-circle me-2 me-sm-3"></i>
                            <p class="fs-sm mb-1">@lang('car_photos_text')  </p>
                        </div>
                    </div> 
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class = "form-group" style="    width: 100%;display: block;">
                                <label style="display:none;">@lang('chosinia')</label>

                                <label for="images" class="drop-container">
                                    <span class="drop-title">@lang('drop_car_photos')</span>
                                   @lang('ors')
                    ...
                    <div class="col-12 text-start">
                        ...
                        <button type="submit" class="btn btn-primary mb-0 cvf_upload_btn" style="background-color: #20B486!important;border-radius: 20px;border: 0px;padding-left: 20px;padding-right: 20px;">@lang('addds')</button>
                    </div>
...
<script>
        ...
        function initMap() {
            ...
            map = new google.maps.Map(document.getElementById('map'), {
                center: {lat: 42.3154, lng: 43.3569}, // Example center (San Francisco)
