            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">გვერდები</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{--                            </p>--}}
                            <a type="submit" href="{{ route('admin.settings.pages.create') }}" class="btn btn-outline-primary waves-effect waves-light mb-2">
                                დამატება
                            </a>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#blogs').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.settings.pages.ajax') }}",
                    type: 'POST',
                    data: function (d) {
                        d._token = '{{ csrf_token() }}'
                    }
        ...
        function deletePage(id) {
            Swal.fire({
                title: 'ნამდვილად გსურთ გვერდის წაშლა?',
                text: "",
                icon: 'question',
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.settings.pages.delete') }}",
                            type: "POST",
                            dataType: "JSON",
                            data: {
                                '_token': '{{ csrf_token() }}',
                            ...
                            .done(function (response) {
                                if (response.status === 1) {
                                    Swal.fire('წარმატებული','პარტნიორი კომპანია წარმატებით წაიშალა','success');
                                    reload();
                                } else {
