...
{{--        </li>--}}
        ...
        <li>
            <a href="javascript: void(0);" class="has-arrow waves-effect">
                <i class="fa fa-cog"></i>
                <span key="t-dashboards">პარამეტრები</span>
            </a>
            <ul class="sub-menu" aria-expanded="false">
                <li><a href="{{ route('admin.settings.pages.index') }}" key="t-default">გვერდები</a></li>
{{--                <li><a href="{{ route('admin.settings.languages.index') }}" key="t-default">თარგმანი</a></li>--}}
            </ul>
        </li>
        @endif
{{--        <li>--}}
...
{{--            </a>--}}
{{--            <ul class="sub-menu" aria-expanded="false">--}}
{{--                <li><a href="{{ route('admin.settings.partner.companies.index') }}" key="t-default">პარტნიორი კომპანიები</a></li>--}}
{{--                <li><a href="{{ route('admin.settings.services.index') }}" key="t-default">სერვისები</a></li>--}}
{{--                <li><a href="{{ route('admin.settings.contact.index') }}" key="t-default">საკონტაქტო ინფორმაცია</a></li>--}}
{{--                <li><a href="{{ route('admin.settings.about.index') }}" key="t-default">ჩვენ შესახებ</a></li>--}}
{{--                <li><a href="{{ route('admin.settings.languages.index') }}" key="t-default">თარგმანი</a></li>--}}
{{--            </ul>--}}
{{--        </li>--}}
{{--        @endif--}}
        ...
        {{--                        <li><a href="layouts-hori-topbar-light.html" key="t-topbar-light">Topbar light</a>--}}
        {{--                        </li>--}}
        ...
        {{--                <li><a href="auth-email-verification.html" key="t-email-verification">Email verification</a>--}}
        {{--                </li>--}}
        {{--                <li><a href="auth-email-verification-2.html" key="t-email-verification-2">Email Verification--}}
        {{--                        2</a></li>--}}
