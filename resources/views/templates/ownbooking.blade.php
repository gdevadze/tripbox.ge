...
<div class="row g-4 mb-5 mt-4">
                ...
                <div class="col-md-3">
					<div class="card card-body   bg-of-boxes" style="background: #F0F7F1;" >
							...
							<div>
							<h5 class="h6">დღევანდელი ჯავშნები</h5>
							<div class="d-flex justify-content-between">
                ...
                <div class="col-md-3">
					<div class="card card-body   bg-of-boxes" style="background: #F0F7F1;">
							...
							<div>
							<h5 class="h6">ახალი ჯავშვნები</h5>
							<div class="d-flex justify-content-between">
                ...
                <div class="col-md-3">
					<div class="card card-body   bg-of-boxes" style="background: #F0F7F1;">
							...
							<div>
							<h5 class="h6">გაუქმებული ჯავშნები</h5>
							<div class="d-flex justify-content-between">
...
<style>
    ...
    margin-right: 15px;
      ...
      <thead>
        <tr>
          <th scope="col">ტრანსპორტი</th>
          <th scope="col">მძღოლი</th>
          <th scope="col">კლიენტი</th>
          <th scope="col">წამოყვანა</th>
          <th scope="col">დატოვება</th>
      ...
      <tbody>
        ...
        <tr >
          ...
          <td>
            ID: #242 <Br />
            <img src="https://tripbox.phpweb.ge/storage/images/cars/car-17-TuzoF//property-image-Gq5E3EQpLs-1716534649.jpg" style="height:50px;" alt="Card image 17"> 
