...
.form-fs-md .form-control 
{
    ...
    <section class="pt-0" id="search-block" style="    scroll-margin-block-start: 110px;scroll-margin-block-end: 110px;">
            ...
            @include('website.particials.sidebar',['categories' => $categories,'brands' => $brands])
                    ...
                    <div class="col-xl-8 col-xxl-9">
                        ...
                        <select id="sortby" onchange="sortChange()" style="width:25%;background:#fff;;border: 1px solid #000000; border-radius: 10px; text-transform: uppercase; color: #1E234C; font-weight: bold; height: 42px; font-size: 12px; padding-top: 12px; padding-left: 10px; padding-right: 10px;">
                                            <option>@lang('cost')</option>
...
<div style="width: 100%; text-align: center;border: 1px solid #000000; border-radius: 10px; text-transform: uppercase; color: #1E234C; font-weight: bold; height: 42px; font-size: 12px; padding-top: 12px; padding-left: 10px; padding-right: 10px;">
    ALL
</div>
</a>
...
<div style="width: 100%; text-align: center;border: 1px solid #000000; border-radius: 10px; text-transform: uppercase; color: #1E234C; font-weight: bold; height: 42px; font-size: 12px; padding-top: 12px; padding-left: 10px; padding-right: 10px;" @if(\request()->city == 'Batumi') class="green_active" @endif>
    Batumi
</div>
</a>
...
<div style="width: 100%; text-align: center;border: 1px solid #000000; border-radius: 10px; text-transform: uppercase; color: #1E234C; font-weight: bold; height: 42px; font-size: 12px; padding-top: 12px; padding-left: 10px; padding-right: 10px;" @if(\request()->city == 'Tbilisi') class="green_active" @endif>
    Tbilisi
</div>
</a>
...
<div style="width: 100%; text-align: center;border: 1px solid #000000; border-radius: 10px; text-transform: uppercase; color: #1E234C; font-weight: bold; height: 42px; font-size: 12px; padding-top: 12px; padding-left: 10px; padding-right: 10px;" @if(\request()->city == 'Kutaisi') class="green_active" @endif>
    Kutaisi
</div>
</a>
...
@endphp
        <h5 class="fw-normal text-success mb-0 me-1" style="    color: #232538!important;font-weight: bold!important;">       $ {{ ($diffDays * $carPrice) + ($diffDays * $carPrice * 20 / 100) }}</h5>
...
@endphp
        ...
        style="    color: #232538!important;font-weight: bold!important;">$ {{ ($diffDays * $carPrice) + ($diffDays * $carPrice * 20 / 100) }}</h5>
...
$( function() {
    ...
    function sortChange() {
        ...
        params.delete('sort_by');  // delete city parameter if it exists, in case you change the dropdown more then once
        params.append('sort_by', document.getElementById("sortby").value);
        // params.append('show_limit', document.getElementById("show_limit").value);
