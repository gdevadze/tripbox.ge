...
<meta property="og:image" content="https://tripbox.ge/assets/images/last/map.png" />
<meta property="twitter:card" content="summary_large_image" />
<meta property="twitter:url" content="{{url()->current()}}" />
<meta property="twitter:title" content="@lang('meta_title')" />
<meta property="twitter:description" content="@lang('meta_description')" />
<meta property="twitter:image" content="https://tripbox.ge/assets/images/last/map.png" />
@endsection
...
{{-- 
    ...
    @include('website.particials.search_bar')

<!-- scroll-margin-block-start: 110px;scroll-margin-block-end: 110px; -->
        <section class="pt-0" id="search-block" style="    ">
            <div class="container">
                <div class="row">
                                ...
                                <div style="border: 1px solid #E4E6E8;    border-radius: 32px;">
                                    ...
                                    <div class="card  p-2 pb-0 h-100" style="        background: #fff0;margin-left: -9px !important; margin-right: -9px !important;">
                                        ...
                                        <div class="card-body px-3 pb-0" style="    padding-top: 10px;">
                                            ...
                                            <img id="add-to-favorite-{{ $car->id }}" @if($savedFavorite) class="added_favorites" @endif src="assets/images/svg/favourite.svg" style="height: 20px; position: absolute; right: 0; margin-right: 30px; margin-top: -20px;">
                                            </a>
...
@endphp
        ...
        <span class="mb-0 me-2" style="text-transform: capitalize; font-size: 13px; padding-left: 5px;">/ @if($diffDays == '1') @lang('days_diferent') @else @lang('dayes') @endif</span>
    </div>
...
<g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 5.29289C5.68342 4.90237 6.31658 4.90237 6.70711 5.29289L12 10.5858L17.2929 5.29289C17.6834 4.90237 18.3166 4.90237 18.7071 5.29289C19.0976 5.68342 19.0976 6.31658 18.7071 6.70711L13.4142 12L18.7071 17.2929C19.0976 17.6834 19.0976 18.3166 18.7071 18.7071C18.3166 19.0976 17.6834 19.0976 17.2929 18.7071L12 13.4142L6.70711 18.7071C6.31658 19.0976 5.68342 19.0976 5.29289 18.7071C4.90237 18.3166 4.90237 17.6834 5.29289 17.2929L10.5858 12L5.29289 6.70711C4.90237 6.31658 4.90237 5.68342 5.29289 5.29289Z" fill="#fff"/> </g>
        ...
        <section style="    padding-top: 0px">
            <div class="container">
                ...
                <div class="disables_mobiles">

                
                <div class="home-banner ">
                    <img src="/assets/images/Rectangle%2041.png">
                    <div>
                        <h5>@lang('discover_georgia_txts')</h5>
                        <p>@lang('text_inside')</p>
                    </div>
                    <a href="/discover-georgia"><svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="24.5" cy="24.5" r="24" fill="white" stroke="black"/>
<path d="M35.7071 25.7071C36.0976 25.3166 36.0976 24.6834 35.7071 24.2929L29.3431 17.9289C28.9526 17.5384 28.3195 17.5384 27.9289 17.9289C27.5384 18.3195 27.5384 18.9526 27.9289 19.3431L33.5858 25L27.9289 30.6569C27.5384 31.0474 27.5384 31.6805 27.9289 32.0711C28.3195 32.4616 28.9526 32.4616 29.3431 32.0711L35.7071 25.7071ZM9 26H35V24H9V26Z" fill="black"/>
</svg>
</a>
                </div>
                ...
                <div class="disables_mobiles">
                    ...
                    <div class="home-banner " style="    padding-bottom: 14px;">
                        <h3>-30 %</h3>
                        <div>
                            <h5>@lang('percentage_offer')</h5>
                            <p>@lang('during_registration')</p>
                        </div>
                        <a href="/register"><svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="24.5" cy="24.5" r="24" fill="white" stroke="black"/>
                    <path d="M35.7071 25.7071C36.0976 25.3166 36.0976 24.6834 35.7071 24.2929L29.3431 17.9289C28.9526 17.5384 28.3195 17.5384 27.9289 17.9289C27.5384 18.3195 27.5384 18.9526 27.9289 19.3431L33.5858 25L27.9289 30.6569C27.5384 31.0474 27.5384 31.6805 27.9289 32.0711C28.3195 32.4616 28.9526 32.4616 29.3431 32.0711L35.7071 25.7071ZM9 26H35V24H9V26Z" fill="black"/>
                    </svg>
                    </a>
...
$(function() {
  $('input[name="date_from"]').daterangepicker({
    ...
    endDate: moment().startOf('hour').add(24, 'hours'), // Default to a 2-day range
            ...
            $.ajax({
                ...
                error: function (xhr, ajaxOptions, thrownError) {
                    if (xhr.status == 401) {
                        Swal.fire({
                            title: "{{__('erros_favo')}}",
                            text: "{{__('for_add_please_login_in')}}",
                            icon: 'error',
