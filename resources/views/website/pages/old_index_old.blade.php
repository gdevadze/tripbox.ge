...
.home-banner div,.home-banner h3{margin-top:23px;margin-right:20px}.choices .choices__inner{border:2px solid #48713a94;border-radius:8px;border:1px solid #cbc2c2}.choices__list--single .choices__item{width:100%;padding-left:20px}.form-control-border .form-label,.home-banner div h5{margin-bottom:0}.form-fs-md .form-control{border-top-left-radius:16px;border-bottom-left-radius:16px;border:1px solid #cbc2c2}.home-banner{background:#f7faed;display:flex;border-radius:6px;padding-top:10px;padding-left:20px;padding-right:20px}.home-banner img{height:103px;object-fit:contain}.home-banner a{margin-top:23px}.home-banner h3{border-right:2px solid #555;padding-right:20px}.car-parametres li{font-size:15px;text-align:left}.ratings-home-car{border:1px solid #e4e6e8;box-shadow:0 2px 7px 0 #00000012;border-radius:50px;display:inline-flex;padding:10px;font-size:10px;position:absolute;margin-top:-40px;background:#fff;right:0;margin-right:35px}.ratings-home-car h5{font-size:13px;margin-bottom:0}.ratings-home-car h5 span{color:#737373;font-weight:300}.card-metro img{height:265px;object-fit:cover;width:100%}
    ...
    color: #1E234C;
    font-weight: bold;    padding-top: 27px;">
                            No Deposite
                        </div>
                                ...
                                <div style="border: 1px solid #E4E6E8;    border-radius: 32px;">
                                    ...
                                    <div class="card  p-2 pb-0 h-100" style="        background: #fff0;margin-left: -9px !important; margin-right: -9px !important;">
                                     ...
                                     <span style="color: #898B9E; font-size: 14px; font-weight: 300; padding-left: 23px; border-right: 1px solid #555; padding-right: 15px;">Or Similar</span>
										<span style="color: #898B9E; font-size: 14px; font-weight: 300; padding-left: 10px;">{{ $car->category->title }}</span>
										</div>
...
<path d="M12.1485 4.58597C12.0733 4.35354 11.8672 4.18846 11.6233 4.16648L8.31025 3.86566L7.00021 0.799381C6.90362 0.574662 6.68363 0.429199 6.4392 0.429199C6.19478 0.429199 5.97479 0.574662 5.8782 0.799906L4.56816 3.86566L1.25465 4.16648C1.01119 4.18899 0.805566 4.35354 0.729988 4.58597C0.65441 4.81839 0.724208 5.07332 0.908379 5.23403L3.4126 7.43024L2.67416 10.6831C2.62013 10.9222 2.71296 11.1695 2.9114 11.3129C3.01807 11.39 3.14287 11.4292 3.26871 11.4292C3.37722 11.4292 3.48485 11.3999 3.58144 11.3421L6.4392 9.63417L9.29592 11.3421C9.50496 11.4679 9.76847 11.4564 9.96648 11.3129C10.165 11.169 10.2578 10.9217 10.2037 10.6831L9.46529 7.43024L11.9696 5.23446C12.1537 5.07332 12.224 4.81883 12.1485 4.58597Z" fill="#FFC700"/>
  ...
  <h5>4.96 <span>(672 reviews)</span></h5>
    ...
    font-size: 13px;
    padding: 3px 5px;">NO DEPOSIT</span>
                                        @endif
                                        {{----<span style="color: #555; font-size: 13px; padding: 3px 5px; text-align: right; position: absolute; margin-right: 10px; right: 17px;">15% OFF </span>----}}
                                        </div>
...
<path d="M6.00016 0C2.805 0 0.205566 2.59944 0.205566 5.79456C0.205566 9.75981 5.39116 15.581 5.61194 15.8269C5.81932 16.0579 6.18138 16.0575 6.38838 15.8269C6.60916 15.581 11.7948 9.75981 11.7948 5.79456C11.7947 2.59944 9.19529 0 6.00016 0ZM6.00016 8.70997C4.3926 8.70997 3.08478 7.40212 3.08478 5.79456C3.08478 4.187 4.39263 2.87919 6.00016 2.87919C7.60769 2.87919 8.9155 4.18703 8.9155 5.79459C8.9155 7.40216 7.60769 8.70997 6.00016 8.70997Z" fill="#D6D7D8"/>
                                                ...
                                                <!-- <li class="nav-item" style="width: 30%;    text-align: center;">
                                                    
                                                <svg width="32" height="27" viewBox="0 0 32 27" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M18.0848 15.0002H14.3348C12.9848 15.0002 10.4348 14.3177 10.4348 11.7302C10.4348 9.14267 12.9848 8.46017 14.3348 8.46017H17.6648C17.7773 8.46017 20.4398 8.42267 20.4398 6.31517C20.4398 4.20767 17.7773 4.17017 17.6648 4.17017H13.9148C13.7656 4.17017 13.6226 4.1109 13.5171 4.00541C13.4116 3.89992 13.3523 3.75685 13.3523 3.60767C13.3523 3.45848 13.4116 3.31541 13.5171 3.20992C13.6226 3.10443 13.7656 3.04517 13.9148 3.04517H17.6648C19.0148 3.04517 21.5648 3.72767 21.5648 6.31517C21.5648 8.90267 19.0148 9.58517 17.6648 9.58517H14.3348C14.2223 9.58517 11.5598 9.62267 11.5598 11.7302C11.5598 13.8377 14.2223 13.8752 14.3348 13.8752H18.0848C18.234 13.8752 18.3771 13.9344 18.4826 14.0399C18.5881 14.1454 18.6473 14.2885 18.6473 14.4377C18.6473 14.5869 18.5881 14.7299 18.4826 14.8354C18.3771 14.9409 18.234 15.0002 18.0848 15.0002Z" fill="#959595"/>
													<path d="M11.8299 6.2326C11.4823 6.22964 11.1386 6.15824 10.8185 6.02246C10.4984 5.88668 10.2082 5.68918 9.96445 5.44125C9.7207 5.19332 9.52817 4.8998 9.39785 4.57746C9.26753 4.25512 9.20197 3.91027 9.20493 3.5626C9.20788 3.21492 9.27929 2.87123 9.41507 2.55115C9.55085 2.23108 9.74834 1.94087 9.99627 1.69712C10.2442 1.45337 10.5377 1.26083 10.8601 1.13051C11.1824 1.00019 11.5273 0.934641 11.8749 0.937596C12.5771 0.943563 13.2481 1.22822 13.7404 1.72894C14.2327 2.22966 14.5059 2.90543 14.4999 3.6076C14.494 4.30976 14.2093 4.98079 13.7086 5.47307C13.2079 5.96535 12.5321 6.23856 11.8299 6.2326ZM11.8299 2.0626C11.4321 2.0626 11.0506 2.22063 10.7693 2.50194C10.488 2.78324 10.3299 3.16477 10.3299 3.5626C10.3299 3.96042 10.488 4.34195 10.7693 4.62326C11.0506 4.90456 11.4321 5.0626 11.8299 5.0626C12.2278 5.0626 12.6093 4.90456 12.8906 4.62326C13.1719 4.34195 13.3299 3.96042 13.3299 3.5626C13.3299 3.16477 13.1719 2.78324 12.8906 2.50194C12.6093 2.22063 12.2278 2.0626 11.8299 2.0626ZM20.1699 17.0626C19.8223 17.0636 19.4778 16.9961 19.1562 16.8639C18.8346 16.7318 18.5422 16.5376 18.2957 16.2925C18.0491 16.0473 17.8533 15.756 17.7193 15.4352C17.5854 15.1143 17.5159 14.7703 17.5149 14.4226C17.5139 14.0749 17.5814 13.7305 17.7136 13.4089C17.8457 13.0873 18.0399 12.7949 18.2851 12.5483C18.5302 12.3018 18.8215 12.106 19.1423 11.972C19.4632 11.838 19.8073 11.7686 20.1549 11.7676C20.8571 11.7656 21.5313 12.0426 22.0292 12.5377C22.5271 13.0328 22.8079 13.7054 22.8099 14.4076C22.8119 15.1098 22.5349 15.7839 22.0398 16.2819C21.5447 16.7798 20.8721 17.0606 20.1699 17.0626ZM20.1699 12.8926C19.7721 12.8926 19.3906 13.0506 19.1093 13.3319C18.828 13.6132 18.6699 13.9948 18.6699 14.3926C18.6699 14.7904 18.828 15.172 19.1093 15.4533C19.3906 15.7346 19.7721 15.8926 20.1699 15.8926C20.5678 15.8926 20.9493 15.7346 21.2306 15.4533C21.5119 15.172 21.6699 14.7904 21.6699 14.3926C21.6699 13.9948 21.5119 13.6132 21.2306 13.3319C20.9493 13.0506 20.5678 12.8926 20.1699 12.8926Z" fill="#959595"/>
													<path d="M2.352 18.424C2.96 18.424 3.48533 18.5387 3.928 18.768C4.376 18.992 4.71733 19.3147 4.952 19.736C5.192 20.1573 5.312 20.6533 5.312 21.224C5.312 21.7947 5.192 22.2907 4.952 22.712C4.71733 23.128 4.376 23.448 3.928 23.672C3.48533 23.8907 2.96 24 2.352 24H0.616V18.424H2.352ZM2.352 23.4C3.072 23.4 3.62133 23.2107 4 22.832C4.37867 22.448 4.568 21.912 4.568 21.224C4.568 20.5307 4.376 19.9893 3.992 19.6C3.61333 19.2107 3.06667 19.016 2.352 19.016H1.344V23.4H2.352ZM10.2723 21.64C10.2723 21.7787 10.2643 21.9253 10.2483 22.08H6.74425C6.77092 22.512 6.91758 22.8507 7.18425 23.096C7.45625 23.336 7.78425 23.456 8.16825 23.456C8.48292 23.456 8.74425 23.384 8.95225 23.24C9.16558 23.0907 9.31492 22.8933 9.40025 22.648H10.1843C10.0669 23.0693 9.83225 23.4133 9.48025 23.68C9.12825 23.9413 8.69092 24.072 8.16825 24.072C7.75225 24.072 7.37892 23.9787 7.04825 23.792C6.72292 23.6053 6.46692 23.3413 6.28025 23C6.09358 22.6533 6.00025 22.2533 6.00025 21.8C6.00025 21.3467 6.09092 20.9493 6.27225 20.608C6.45358 20.2667 6.70692 20.0053 7.03225 19.824C7.36292 19.6373 7.74158 19.544 8.16825 19.544C8.58425 19.544 8.95225 19.6347 9.27225 19.816C9.59225 19.9973 9.83758 20.248 10.0083 20.568C10.1843 20.8827 10.2723 21.24 10.2723 21.64ZM9.52025 21.488C9.52025 21.2107 9.45892 20.9733 9.33625 20.776C9.21358 20.5733 9.04558 20.4213 8.83225 20.32C8.62425 20.2133 8.39225 20.16 8.13625 20.16C7.76825 20.16 7.45358 20.2773 7.19225 20.512C6.93625 20.7467 6.78958 21.072 6.75225 21.488H9.52025ZM11.9612 18.08V24H11.2332V18.08H11.9612ZM13.5779 18.904C13.4393 18.904 13.3219 18.856 13.2259 18.76C13.1299 18.664 13.0819 18.5467 13.0819 18.408C13.0819 18.2693 13.1299 18.152 13.2259 18.056C13.3219 17.96 13.4393 17.912 13.5779 17.912C13.7113 17.912 13.8233 17.96 13.9139 18.056C14.0099 18.152 14.0579 18.2693 14.0579 18.408C14.0579 18.5467 14.0099 18.664 13.9139 18.76C13.8233 18.856 13.7113 18.904 13.5779 18.904ZM13.9299 19.616V24H13.2019V19.616H13.9299ZM16.8027 23.328L18.1627 19.616H18.9387L17.2187 24H16.3707L14.6507 19.616H15.4347L16.8027 23.328ZM23.6551 21.64C23.6551 21.7787 23.6471 21.9253 23.6311 22.08H20.1271C20.1537 22.512 20.3004 22.8507 20.5671 23.096C20.8391 23.336 21.1671 23.456 21.5511 23.456C21.8657 23.456 22.1271 23.384 22.3351 23.24C22.5484 23.0907 22.6977 22.8933 22.7831 22.648H23.5671C23.4497 23.0693 23.2151 23.4133 22.8631 23.68C22.5111 23.9413 22.0737 24.072 21.5511 24.072C21.1351 24.072 20.7617 23.9787 20.4311 23.792C20.1057 23.6053 19.8497 23.3413 19.6631 23C19.4764 22.6533 19.3831 22.2533 19.3831 21.8C19.3831 21.3467 19.4737 20.9493 19.6551 20.608C19.8364 20.2667 20.0897 20.0053 20.4151 19.824C20.7457 19.6373 21.1244 19.544 21.5511 19.544C21.9671 19.544 22.3351 19.6347 22.6551 19.816C22.9751 19.9973 23.2204 20.248 23.3911 20.568C23.5671 20.8827 23.6551 21.24 23.6551 21.64ZM22.9031 21.488C22.9031 21.2107 22.8417 20.9733 22.7191 20.776C22.5964 20.5733 22.4284 20.4213 22.2151 20.32C22.0071 20.2133 21.7751 20.16 21.5191 20.16C21.1511 20.16 20.8364 20.2773 20.5751 20.512C20.3191 20.7467 20.1724 21.072 20.1351 21.488H22.9031ZM25.344 20.328C25.472 20.0773 25.6533 19.8827 25.888 19.744C26.128 19.6053 26.4187 19.536 26.76 19.536V20.288H26.568C25.752 20.288 25.344 20.7307 25.344 21.616V24H24.616V19.616H25.344V20.328ZM31.3764 19.616L28.7364 26.064H27.9844L28.8484 23.952L27.0804 19.616H27.8884L29.2644 23.168L30.6244 19.616H31.3764Z" fill="#959595"/>
													</svg>
...
<div class="d-sm-flex justify-content-sm-between align-items-center">
    ...
    <div class="d-flex justify-content-between" data-bs-toggle="tooltip" data-bs-html="true" 
        ...
        title="{{ $car->price + ($car->price * 20 / 100) }}$ (1/4) დღე <br /> {{ $car->price_5_9 + ($car->price_5_9 * 20 / 100) }}$ (5/9) დღე <br /> {{ $car->price_10 + ($car->price_10 * 20 / 100) }}$ (10+) დღე" style="cursor:pointer;    padding-top: 2px;">
        <h5 class="fw-normal text-success mb-0 me-1" 
        
        style="    color: #232538!important;font-weight: bold!important;">${{ $car->price + ($car->price * 20 / 100) }}</h5>
        <span class="mb-0 me-2" style="text-transform: capitalize; font-size: 13px; padding-left: 5px;    padding-top: 5px;">/ @lang('dayes')</span>

        <div class="mt-sm-0 z-index-2">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary-soft mb-0 w-100 car-detail" data-id="{{ $car->id }}" style="background: #20B486; color: #fff; border: 0; border-radius: 40px; font-size: 11px;">@lang('books_it')<i class="bi bi-arrow-right ms-2"></i></a>
    </div>
    </div>
