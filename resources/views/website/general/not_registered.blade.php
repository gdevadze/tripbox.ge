...
<!-- -->
    <div class="col-md-6">
					...
					<div class="card  p-2 pb-0 " style="  background: #ffffff; box-shadow: 4px 4px 15px 0px #00000026;">
						...
						<div class="card-body px-3 pb-0" style="   padding-bottom: 50px;    padding-top: 10px;">
							...
							<h5 class="card-title" style="     margin-bottom: 0px;   font-size: 20px;"><a href="#">{{ $car->brand->name }} {{ $car->brand_model->name }} {{ $carPrice }}</a></h5>
    ...
    padding-right: 10px;">Or Similar</p>
                            ...
                            <img id="add-to-favvorite-{{ $car->id }}" src="{{asset('/assets/images/svg/favourite.svg')}}" style="height: 20px; position: absolute; right: 0; margin-right: 30px; margin-top: -20px;">
                            </a>
...
<h4 style="margin-top:40px;margin-bottom:30px;    font-size: 20px;">@lang('personal_info')</h4>




<form class="row g-3 not-registered-form" id="msform">
								
								
								<div class="col-md-6">
								
									<input type="text" class="form-control" id="name" required placeholder="@lang('name')">
								</div>

                                <div class="col-md-6">
								
									<input type="text" class="form-control" id="surname" required placeholder="@lang('surname')">
								</div>
                                ...
                                <div class="col-md-6">
									...
									<input type="text" class="form-control" id="country" required placeholder="@lang('country')">
								</div>

                                <div class="col-md-6">
								
                                <input type="text" class="form-control" id="tel" required placeholder="@lang('telephone')">
                            </div>
                            
                            <div class="col-md-12">
								<textarea class="form-control" id="wishes" placeholder="@lang('wishes')" ></textarea>
...
<h4 style="margin-top:40px;margin-bottom:30px;    font-size: 20px;">@lang('prince_include')</h4>
...
<div class="d-flex" style="margin-left: 20px;">
                        ...
                        <ul class="items-routes" style="margin-top: 30px;padding-bottom:0px;
    padding-left: 0px;    margin-bottom: 0px;">

<li style="    box-shadow: 4px 4px 15px 0px #00000000;margin-bottom:0px;">
...
<h4 style="margin-left: 20px;margin-top:40px;margin-bottom:30px;    font-size: 20px;">@lang('cost')</h4>
                                ...
                                @php
                                $percentPrice = $diffDays * $carPrice * 15 / 100;
                                $totalPrice = $diffDays * $carPrice;
                                @endphp
									<li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <!-- -->
                                        {{ $totalPrice + $percentPrice + $deliveryPrice + $refundPrice }}$
                                        <!-- -->
                                        </span>
									</li>
                                ...
                                <a class="src-btn add-to-cart" data-id="{{ $car->id }}" href="javascript:0;" style="padding-top: 10px; padding-bottom: 10px; border-radius: 40px;    background: #79C064; width: 100%!important; display: block; text-align: center;margin-left: 20px;margin-top:40px;margin-bottom:30px;     width: 90% !important; ">@lang('payes')</a>
