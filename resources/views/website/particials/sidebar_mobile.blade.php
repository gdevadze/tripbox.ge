<div class="modal fade" id="exampleModal_search_brand" tabindex="-1" aria-labelledby="exampleModal_search_brandLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModal_search_brandLabel">@lang('filter')</h1>
