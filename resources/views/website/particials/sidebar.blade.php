...
<div class="filter-sidebar"  >
    ...
    <h5 style="color:#232538;font-size: 20px;margin-bottom: 20px;"></h5>
    <div class=" flex-column p-3 p-xl-0">
        <form style="border: 1px solid #AED7A0;
    border-radius: 30px;">

            <form class="rounded-3 shadow">
                <input hidden name="location_from" value="{{ \request()->location_from }}">
                <input hidden name="location_to" value="{{ \request()->location_to }}">
                <input hidden name="date_from" value="@if(isset($startDate) && isset($endDate)) $startDate.' - '.$endDate @else {{ \request()->date_from }} @endif">
